...
(define-derived-mode calc-keypad-mode fundamental-mode "Calculator"
  ...
  (define-key calc-keypad-mode-map [mouse-3] 'calc-keypad-press)
  (define-key calc-keypad-mode-map [mouse-2] 'calc-keypad-press)
  (define-key calc-keypad-mode-map [mouse-1] 'calc-keypad-press)
